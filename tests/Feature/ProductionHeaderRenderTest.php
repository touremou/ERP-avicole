...
test('les en-têtes hors-production migrés affichent leur accent propre', function () {
    $cases = [
        ...
        ['budgets.index',   'Suivi Budgétaire',    'bg-indigo-600'],
        ['stock-adjustments.index', 'Démarque',    'bg-orange-500'],
        ['planning.index',  'Planification',       'bg-indigo-600'],
        ['incubations.index','Couvoir',            'bg-blue-600'],
        ['farms.index',     'Multi-Sites',         'bg-violet-500'],
        ['settings.index',  'Paramètres',          'bg-slate-900'],
        ['health.index',    'Registre Sanitaire',  'bg-purple-600'],
        ['providers.index', 'Annuaire Partenaires','bg-blue-600'],
        ['buildings.index', 'Parc de Production',   'bg-indigo-600'],
        ...
        ['annuaire.index',  'Annuaire / Tiers',     'bg-orange-500'],
        ['rh.index',        'Ressources Humaines',  'bg-violet-500'],
