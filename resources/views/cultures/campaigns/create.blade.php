<x-app-layout>
    <x-slot name="header">
        <x-page-header :title="__('Nouvelle campagne')" :subtitle="__('Planification d\'une saison culturale')" icon="fa-calendar-week" accent="green" :back="route('crop-campaigns.index')" />
    </x-slot>
