    ...
    <div class="bg-amber-500 text-white" x-data="{ show: true }" x-show="show">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5 flex items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-2 shrink-0">
                ...
                <button type="button" @click="show = false" aria-label="{{ __('Fermer') }}" class="text-white/80 hover:text-white border-none bg-transparent cursor-pointer text-base leading-none">
                    ✕
                </button>
            </div>
        </div>
