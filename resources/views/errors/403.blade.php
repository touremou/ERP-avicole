...
<head>
    ...
    <title>Accès refusé — AviSmart</title>
...
<body class="bg-slate-50 min-h-screen flex items-center justify-center p-6 italic">
    <div class="max-w-md w-full text-center">
        <div class="bg-white p-12 rounded-[3rem] border border-slate-100 shadow-xl">
            ...
            <h1 class="text-2xl font-black text-slate-800 uppercase tracking-tighter mb-3">Accès Refusé</h1>
            <p class="text-sm text-slate-500 font-bold mb-8">Vous n'avez pas les permissions nécessaires pour cette action. Contactez votre administrateur.</p>
