<x-app-layout>
    <x-slot name="header">
        <x-page-header :title="__('👥 Ressources Humaines')" :subtitle="__('Équipe · Présence · Paie')" icon="fa-user-tie" accent="violet">
            <x-slot name="actions">
                @can('rh.C')
    ...
    <div class="py-10">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 italic font-bold text-left space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                {{-- Masse salariale : donnée sensible, réservée au responsable paie (rh.M). --}}
                @can('rh.M')
                <div class="bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm text-center">
            ...
            @php
                $groups = [
                    ...
                    ['title' => 'Paie', 'color' => 'emerald', 'items' => [
                        ...
                        ['label' => 'Congés', 'icon' => 'fa-umbrella-beach', 'route' => 'payroll.leaves', 'can' => 'rh.L'],
                    ]],
                ];
            @endphp
