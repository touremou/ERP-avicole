                ...
                <div class="px-10 py-6 border-t border-slate-100 bg-slate-50 shrink-0">
                    <div class="flex justify-between items-center">
                        <div class="flex gap-4">
                            ...
                            <span class="text-[8px] font-black uppercase text-slate-400 flex items-center gap-1"><span class="w-4 h-4 bg-amber-500 rounded text-white text-[8px] flex items-center justify-center">C</span> Création</span>
                            ...
                            <span class="text-[8px] font-black uppercase text-slate-400 flex items-center gap-1"><span class="w-4 h-4 bg-red-500 rounded text-white text-[8px] flex items-center justify-center">S</span> Suppression</span>
                        </div>
