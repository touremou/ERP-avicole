    ...
    <x-slot name="header">
        <div class="flex justify-between items-center text-left">
            <h2 class="text-2xl font-black text-slate-800 uppercase italic tracking-tighter leading-none">
                <i class="fa-solid fa-plus-circle text-emerald-500 mr-2"></i> Nouvel Article
            </h2>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <form action="{{ route('stocks.store') }}" method="POST" class="space-y-8 relative z-10">
                        ...
                        <div class="grid grid-cols-1 gap-8">
                            ...
                            <div x-show="cat === 'conso'" class="bg-orange-50/50 p-6 rounded-[2.5rem] border border-orange-100 shadow-inner">
                                <label class="text-[10px] uppercase text-orange-500 ml-6 mb-2 block tracking-widest italic font-black">01. Nature du produit</label>
                                <select name="metadata[conso_type]" x-model="consoType" class="w-full bg-white border-none rounded-[1.5rem] p-5 font-black text-xs uppercase shadow-sm focus:ring-2 focus:ring-orange-500 italic cursor-pointer">
                                    <option value="Aliment">🌾 Alimentation (Sacs/KG)</option>
                                    <option value="Santé">💉 Santé (Vaccins/Vitamines)</option>
                            ...
                            <div x-show="cat === 'conso' && consoType === 'Aliment'" class="grid grid-cols-2 gap-4">
                                <button type="button" @click="poultryType = 'Chair'" 
                                    ...
                                    <i class="fa-solid fa-feather mr-2"></i> Secteur Chair
                                </button>
                                <button type="button" @click="poultryType = 'Ponte'" 
                                    ...
                                    class="py-4 rounded-2xl text-[10px] font-black uppercase italic tracking-widest transition-all">
                                    <i class="fa-solid fa-egg mr-2"></i> Secteur Ponte
                                </button>
                            ...
                            <div class="text-left">
                                <label class="text-[10px] uppercase text-slate-400 ml-6 mb-2 block tracking-widest leading-none font-black italic">02. Désignation de l'article</label>
                                ...
                                <template x-if="cat === 'oeufs'">
                                    <select name="item_name" required class="w-full bg-slate-50 border-none rounded-[2rem] p-5 font-black uppercase text-sm focus:ring-2 focus:ring-emerald-500 shadow-inner italic appearance-none cursor-pointer">
                                        <option value="">-- Choisir le Calibre --</option>
                                        <option value="Calibre S">Calibre S</option>
                                        <option value="Calibre M">Calibre M</option>
                                        <option value="Calibre L">Calibre L</option>
                                        <option value="Calibre XL">Calibre XL</option>
                                        <option value="Œufs Cassés">Œufs Cassés</option>
                                        <option value="Anomaux / Sales">Anomaux / Sales</option>
                                    </select>
                                </template>
                                ...
                                <template x-if="cat !== 'oeufs' && !(cat === 'conso' && consoType === 'Aliment')">
                                    <input type="text" name="item_name" required
                                        ...
                                        placeholder="NOM DU MATÉRIEL OU PRODUIT...">
                                </template>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                                {{-- UNITÉ (DYNAMIQUE) --}}
                                <div>
                                    <label class="text-[10px] uppercase text-slate-400 ml-6 mb-2 block tracking-widest font-black italic">03. Unité</label>
                                ...
                                <div x-show="cat !== 'oeufs'">
                                    <label class="text-[10px] uppercase text-slate-400 ml-6 mb-2 block tracking-widest italic font-black">04. Fournisseur</label>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
                                {{-- SEUIL D'ALERTE --}}
                                <div>
                                    <label class="text-[10px] uppercase text-slate-400 ml-6 mb-2 block tracking-widest font-black italic">05. Seuil d'alerte</label>
                                ...
                                <div>
                                    <label class="text-[10px] uppercase text-slate-400 ml-6 mb-2 block tracking-widest font-black italic">06. Prix Unitaire (GNF)</label>
                                ...
                                <div class="bg-slate-900 rounded-[2.5rem] p-6 text-white shadow-xl relative overflow-hidden group">
                                    <label class="text-[9px] uppercase text-emerald-400 mb-2 block font-black tracking-widest italic leading-none">Stock Initial en Entrée</label>
            ...
            @else
                ...
                <div class="bg-white p-20 rounded-[4rem] border border-slate-100 shadow-xl text-center">
                    ...
                    <p class="text-slate-400 text-[10px] font-black uppercase tracking-widest italic leading-none">La permission <span class="text-blue-500">stocks.C</span> (Créer) est requise pour créer de nouveaux articles.</p>
