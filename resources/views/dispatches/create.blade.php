        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 italic font-bold text-left" x-data="dispatchForm()" x-cloak>
            ...
            <form method="POST" action="{{ route('dispatches.store') }}">
                ...
                <div class="bg-white p-8 rounded-[3rem] border border-slate-100 shadow-sm mb-6">
                    <h3 class="text-[10px] font-black uppercase text-slate-400 tracking-widest mb-6 flex items-center gap-2"><i class="fa-solid fa-truck text-orange-500"></i> Transport</h3>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                        <div class="space-y-2">
                            <label class="text-[9px] font-black uppercase text-slate-400 tracking-widest ml-2">Chauffeur *</label>
                            <input type="text" name="driver_name" required placeholder="Nom complet" class="w-full bg-slate-50 border-none rounded-2xl p-4 text-sm font-black shadow-inner outline-none">
                        </div>
                        <div class="space-y-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="destination" required placeholder="Magasin Conakry..." class="w-full bg-slate-50 border-none rounded-2xl p-4 text-xs font-black shadow-inner outline-none">
                        </div>
                        <div class="space-y-2">
                ...
                <div class="bg-white p-8 rounded-[3rem] border border-slate-100 shadow-sm mb-6">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-[10px] font-black uppercase text-slate-400 tracking-widest flex items-center gap-2"><i class="fa-solid fa-boxes-stacked text-orange-500"></i> Marchandise</h3>
                            ...
                            <div class="grid grid-cols-12 gap-3 items-end">
                                ...
                                <div class="col-span-4">
                                    <label class="text-[8px] font-black uppercase text-orange-600 tracking-widest">
                                        <span x-text="['volaille_vivante','volaille_abattue'].includes(line.product_type) ? 'Lot source' : (line.product_type === 'fumier' ? 'Désignation' : 'Article en stock')"></span>
                                    </label>
