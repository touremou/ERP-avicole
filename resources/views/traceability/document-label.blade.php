...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .label { width: 380px; margin: 0 auto; background: #fff; border: 2px solid {{ $accentColor }}; border-radius: 12px; padding: 18px; display: flex; gap: 16px; align-items: center; }
        ...
        .actions button { background: {{ $accentColor }}; color: #fff; border: 0; padding: 12px 28px; border-radius: 10px; font-weight: 800; font-size: 13px; cursor: pointer; }
        @media print {
...
<body>
    <div class="label">
        ...
        <div class="info">
            <div class="farm">{{ $farm ?? __('Traçabilité') }}</div>
