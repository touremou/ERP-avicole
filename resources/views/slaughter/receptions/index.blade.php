<x-app-layout>
    <x-slot name="header">
        <x-page-header :title="__('Réceptions du vif')" :subtitle="__('CCP 1 — Contrôle ante-mortem à l\'arrivée')" icon="fa-truck-ramp-box" accent="rose" :back="route('slaughter.dashboard')">
            <x-slot name="actions">
                @can('abattoir.C')
