        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 italic font-bold text-left" x-data="slaughterForm()" x-cloak>
            ...
            @can('abattoir.M')
                ...
                <form method="POST" action="{{ route('slaughter.execute.store', $order) }}">
                    ...
                    <div class="bg-white p-8 rounded-[3rem] border border-slate-100 shadow-sm mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-6 mb-6">
                            <div class="space-y-2">
                                <label class="text-[9px] font-black uppercase text-emerald-600 tracking-widest ml-2">Poids vif total ({{ setting('general.weight_unit', 'kg') }}) *</label>
                            ...
                            <div class="space-y-2">
                                <label class="text-[9px] font-black uppercase text-blue-600 tracking-widest ml-2">Poids carcasse total ({{ setting('general.weight_unit', 'kg') }}) *</label>
            ...
            @else
                ...
                <div class="bg-white p-20 rounded-[4rem] border border-slate-100 shadow-xl text-center">
                    ...
                    <p class="text-slate-400 text-[10px] font-black uppercase tracking-widest italic">Vous n'avez pas la permission d'exécuter un ordre d'abattage.</p>
                </div>
            @endcan
        </div>
    </div>
