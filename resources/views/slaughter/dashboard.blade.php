        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 italic font-bold text-left">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
                <div class="bg-white p-5 rounded-[2rem] border border-slate-100 shadow-sm text-center">
                    ...
                    <p class="text-[8px] text-slate-400">{{ setting('abattoir.kpi_days', 30) }} derniers jours</p>
                </div>
                ...
                <div @class(['p-5 rounded-[2rem] border shadow-sm text-center',
                    ...
                    <p class="text-[8px] font-black uppercase tracking-widest mb-1 {{ $kpi['avg_yield'] >= setting('abattoir.yield_target_min', 70) ? 'text-emerald-500' : 'text-amber-500' }}">Rendement carcasse</p>
                    ...
                    <p class="text-[8px] text-slate-400">norme : {{ setting('abattoir.yield_target_min', 70) }}-{{ setting('abattoir.yield_target_max', 75) }}%</p>
                </div>
                ...
                <div class="bg-white p-5 rounded-[2rem] border border-slate-100 shadow-sm text-center">
                    ...
                    <p class="text-[8px] text-slate-400">seuil : < {{ setting('abattoir.condemnation_tolerance', 2) }}%</p>
                </div>
                ...
                <div class="bg-white p-5 rounded-[2rem] border border-slate-100 shadow-sm text-center">
                    ...
                    <p class="text-[8px] text-slate-400">seuil : < {{ setting('abattoir.tolerance_cutting_loss', 10) }}%</p>
                </div>
            </div>
                    ...
                    <div class="divide-y divide-slate-50">
                        ...
                        <div class="px-6 py-4 flex justify-between items-center">
                            <div>
                                ...
                                <p class="text-[8px] text-slate-400 font-black">{{ $order->batch->code ?? '—' }} — {{ $order->planned_quantity }} sujets — {{ $order->planned_date->format(setting('general.date_format', 'd/m/Y')) }}</p>
                            </div>
                            @can('abattoir.M')
