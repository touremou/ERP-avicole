            ...
            <div class="flex items-center gap-4 text-left">
                ...
                <div>
                    <h2 class="font-black text-2xl text-slate-800 uppercase italic tracking-tighter leading-none">
                        Édition : {{ $formula->name }}
                    </h2>
                    <p class="text-[10px] font-bold text-blue-600 uppercase tracking-widest mt-1 italic leading-none">Optimisation de la recette • Labo</p>
                </div>
            </div>
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-white p-10 rounded-[3.5rem] border border-slate-100 shadow-sm grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="md:col-span-2">
                            <label class="block text-[10px] font-black text-slate-400 uppercase mb-2 ml-2 italic tracking-widest leading-none">Nom de la Formule</label>
                    ...
                    <div class="bg-white p-10 rounded-[3.5rem] border border-slate-100 shadow-sm">
                        <div class="flex justify-between items-center mb-8 px-4">
                            <h3 class="text-xs font-black uppercase text-slate-800 italic tracking-tighter leading-none">Mélange des composants</h3>
                        ...
                        <div id="ingredients-container" class="space-y-4">
                            ...
                            <div class="ingredient-row flex flex-col md:flex-row items-center gap-4 p-4 bg-slate-50 rounded-[2rem] border border-slate-100 relative group transition-all hover:bg-white hover:shadow-md">
                                <div class="flex-1 w-full text-left">
                                    <label class="block text-[8px] font-black text-slate-400 uppercase mb-1 ml-2 italic leading-none">Matière Première</label>
                                ...
                                <div class="w-full md:w-32 text-left">
                                    <label class="block text-[8px] font-black text-slate-400 uppercase mb-1 ml-2 italic text-center leading-none">Part (%)</label>
                        ...
                        <div class="mt-8 p-6 rounded-[2.5rem] bg-slate-900 text-white flex justify-between items-center shadow-2xl relative overflow-hidden">
                            ...
                            <div class="text-left relative z-10">
                                <p class="text-[9px] font-black text-blue-400 uppercase italic leading-none mb-1">Équilibre de la Formule</p>
                                <p class="text-[8px] text-slate-400 italic font-bold leading-none">Le dosage cumulé doit être égal à 100%</p>
                            </div>
                    ...
                    <div class="flex flex-col items-center gap-4">
                        ...
                        <p id="alert-msg" class="text-[9px] text-red-500 uppercase font-black italic animate-pulse">L'équilibre à 100% n'est pas atteint</p>
                    </div>
                </div>
            </form>
            @else
