...
return new class extends Migration {
    public function up(): void {
        $settings = [
            ...
            ['group'=>'pisciculture','key'=>'ph_min','value'=>'6.5','type'=>'number','label'=>'pH minimal optimal','description'=>'En dehors de 6.5–8.5 : vigilance. Au-delà de ±0.5 : critique.','display_order'=>3],
            ['group'=>'pisciculture','key'=>'ph_max','value'=>'8.5','type'=>'number','label'=>'pH maximal optimal','display_order'=>4],
            ['group'=>'pisciculture','key'=>'o2_alert','value'=>'4','type'=>'number','label'=>'Seuil alerte O₂ dissous (critique)','description'=>'En dessous : risque d\'asphyxie. +1 mg/L déclenche une alerte de vigilance.','unit'=>'mg/L','display_order'=>5],
            ['group'=>'pisciculture','key'=>'ammonia_alert','value'=>'1','type'=>'number','label'=>'Seuil alerte NH₃ (critique)','description'=>'Au-delà : risque d\'intoxication. La moitié de cette valeur déclenche une alerte de vigilance.','unit'=>'mg/L','display_order'=>6],
