...
return new class extends Migration {
    public function up(): void {
        $settings = [
            ...
            // Tabaski
            ['group'=>'elevage','key'=>'tabaski_date','value'=>'','type'=>'date','label'=>'Date Tabaski / Eid al-Adha','description'=>'Permet le décompte automatique J-60/J-30/J-7 pour les lots ovins.','display_order'=>26],
            ...
            // Général multiespèces
            ['group'=>'general','key'=>'species_enabled','value'=>'["poulet"]','type'=>'json','label'=>'Espèces actives sur ce site','description'=>'Liste JSON des slugs espèces activés sur cette ferme.','display_order'=>15],
        ];
    ...
    public function down(): void {
        DB::table('settings')->whereNull('farm_id')->whereIn('key', [
            'cycle_ovin_engraissement','cycle_ovin_reproducteur','gmq_cible_ovin',
            'cycle_caprin_lait','lait_cible_chevre','gmq_cible_caprin',
            'tabaski_date','tabaski_target_weight',
            'cycle_tilapia','cycle_carpe','ph_min','ph_max','o2_alert',
            'ammonia_alert','temp_min','temp_max','taux_survie_cible','fc_cible',
            'cycle_dinde_chair','cycle_caille_ponte','cycle_caille_chair','species_enabled',
        ])->delete();
    }
};
