...
class ModuleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $modules = [
            ...
            ['name' => 'Dépenses / Achats', 'slug' => 'depenses',   'icon' => 'fa-coins',           'color' => 'rose',    'display_order' => 7],
            ['name' => 'Trésorerie',     'slug' => 'tresorerie',    'icon' => 'fa-wallet',          'color' => 'emerald', 'display_order' => 8],
            ['name' => 'Logistique',     'slug' => 'logistique',    'icon' => 'fa-truck',           'color' => 'orange',  'display_order' => 9],
            ['name' => 'Eau & Énergie',  'slug' => 'ressources',    'icon' => 'fa-bolt',            'color' => 'cyan',    'display_order' => 10],
