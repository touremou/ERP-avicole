    ...
    public function run(): void
    {
        ...
        $protocols = [
            ...
            [
                ...
                'description' => $note,
                'items' => [
                    ['day_number' => 0,   'stage' => 'Plantation', 'action_name' => 'Plantation rejets + fumure organique',      'type' => 'semis',         'product_suggested' => 'Fumier',       'dose' => '10 t/ha',   'method' => 'en fosse', 'notes' => 'Planter des rejets baïonnette sains parés, écartement 2,5 x 2,5 m. Mélanger le fumier à la terre du trou ; éviter les rejets issus de pieds malades.'],
                    ['day_number' => 30,  'stage' => 'Croissance', 'action_name' => 'Désherbage manuel + paillage',              'type' => 'sarclage',      'product_suggested' => null,           'dose' => null,        'method' => 'manuel', 'notes' => 'Désherber et pailler au pied pour conserver l\'humidité et limiter les adventices. Le paillage protège les racines superficielles.'],
                    ['day_number' => 60,  'stage' => 'Croissance', 'action_name' => 'Apport engrais complet NPK',                'type' => 'fertilisation', 'product_suggested' => 'NPK complet',  'dose' => '150 kg/ha', 'method' => 'épandage localisé au pied', 'notes' => 'Épandre en couronne à 30-40 cm du pied sur sol humide. La banane est exigeante en potassium ; éviter le contact direct avec le pseudo-tronc.'],
                    ['day_number' => 90,  'stage' => 'Croissance', 'action_name' => 'Élagage feuilles mortes + observations parasites (charançon)', 'type' => 'observation', 'product_suggested' => null, 'dose' => null, 'method' => 'visuel + élagage', 'notes' => 'Couper et évacuer feuilles mortes et vieux pseudo-troncs (foyers de charançon). Poser des pièges (pseudo-troncs fendus) pour évaluer la population.'],
                    ['day_number' => 120, 'stage' => 'Croissance', 'action_name' => 'Traitement charançon du bananier si nécessaire', 'type' => 'traitement', 'product_suggested' => 'Chlorpyriphos', 'dose' => 'selon étiquette', 'method' => 'application sol si seuil', 'notes' => 'Traiter uniquement si les pièges dépassent le seuil. Appliquer au pied, porter gants et masque, et respecter strictement le délai avant récolte. Privilégier d\'abord l\'assainissement de la bananeraie.'],
                    ['day_number' => 180, 'stage' => 'Croissance', 'action_name' => 'Deuxième apport NPK',                       'type' => 'fertilisation', 'product_suggested' => 'NPK complet',  'dose' => '100 kg/ha', 'method' => 'épandage localisé', 'notes' => 'Fractionner la fumure améliore l\'efficacité. Apporter en couronne sur sol humide et éviter juste avant une forte pluie (lessivage).'],
                    ['day_number' => 270, 'stage' => 'Floraison',  'action_name' => 'Observation floraison',                     'type' => 'observation',   'product_suggested' => null,           'dose' => null,        'method' => 'visuel', 'notes' => 'Surveiller la sortie de l\'inflorescence et étayer les pieds chargés pour éviter la chute. Supprimer le bourgeon mâle après nouaison des dernières mains.'],
                    ['day_number' => 300, 'stage' => 'Fructification', 'action_name' => 'Ensachage régimes (protection qualité)', 'type' => 'autre',        'product_suggested' => null,           'dose' => null,        'method' => 'sac polyéthylène', 'notes' => 'Ensacher les régimes protège des piqûres d\'insectes et des frottements. Utiliser des sacs ajourés pour éviter l\'excès de chaleur.'],
                    ['day_number' => 360, 'stage' => 'Récolte',    'action_name' => 'Récolte régimes (couper à maturité)',        'type' => 'recolte',       'product_suggested' => null,           'dose' => null,        'method' => 'coupe à la machette', 'notes' => 'Récolter quand les fruits sont bien remplis et les angles encore marqués. Manipuler avec soin pour éviter les blessures et transporter à l\'ombre.'],
                ],
            ],
            [
                ...
                'description' => $note,
                'items' => [
                    ['day_number' => 0,  'stage' => 'Semis',      'action_name' => 'Semis + fumure de fond (NPK 15-15-15)',      'type' => 'semis',         'product_suggested' => 'NPK 15-15-15', 'dose' => '100 kg/ha', 'method' => 'en poquets', 'notes' => 'Tremper les graines 12-24 h avant semis pour accélérer la levée. Semer à 2-3 cm, écartement 60 x 40 cm, 2-3 graines par poquet.'],
                    ['day_number' => 10, 'stage' => 'Levée',      'action_name' => 'Démariage (2 plants/poquet)',                'type' => 'autre',         'product_suggested' => null,           'dose' => null,        'method' => 'manuel', 'notes' => 'Conserver les 2 plants les plus vigoureux par poquet pour un bon développement.'],
                    ['day_number' => 20, 'stage' => 'Croissance', 'action_name' => 'Apport urée + sarclage',                    'type' => 'fertilisation', 'product_suggested' => 'Urée 46%',     'dose' => '30 kg/ha',  'method' => 'épandage + sarclage manuel', 'notes' => 'Apporter au pied sur sol humide puis enfouir par sarclage pour limiter la volatilisation. Désherber tôt contre la concurrence.'],
                    ['day_number' => 30, 'stage' => 'Croissance', 'action_name' => 'Traitement pucerons/acariens',              'type' => 'traitement',    'product_suggested' => 'Imidaclopride', 'dose' => 'selon étiquette', 'method' => 'pulvérisation si seuil', 'notes' => 'Traiter seulement au-delà du seuil et hors floraison pour protéger les pollinisateurs. Pulvériser en soirée par temps sec, porter des EPI, alterner les matières actives et respecter le délai avant récolte.'],
                    ['day_number' => 45, 'stage' => 'Floraison',  'action_name' => 'Deuxième apport urée',                      'type' => 'fertilisation', 'product_suggested' => 'Urée 46%',     'dose' => '30 kg/ha',  'method' => 'épandage localisé', 'notes' => 'Fractionner l\'azote soutient la production de gousses. Apporter sur sol humide, à distance du pied, et enfouir légèrement.'],
                    ['day_number' => 55, 'stage' => 'Récolte',    'action_name' => 'Début récolte gousses tendres (tous les 2-3 jours)', 'type' => 'recolte', 'product_suggested' => null,      'dose' => null,        'method' => 'manuel, récolte fréquente', 'notes' => 'Récolter les gousses jeunes et tendres (8-10 cm) tous les 2-3 jours. Une récolte fréquente évite le durcissement et stimule la floraison.'],
                    ['day_number' => 75, 'stage' => 'Récolte',    'action_name' => 'Fin cycle récolte',                         'type' => 'recolte',       'product_suggested' => null,           'dose' => null,        'method' => 'manuel', 'notes' => 'Couper les gousses au sécateur pour ne pas casser les rameaux. Porter des manches longues, les poils du gombo étant irritants.'],
                ],
            ],
            [
                ...
                'description' => $note,
                'items' => [
                    ['day_number' => 0,  'stage' => 'Semis',    'action_name' => 'Semis à la volée',                            'type' => 'semis',       'product_suggested' => 'Semence fonio', 'dose' => '20 kg/ha', 'method' => 'à la volée', 'notes' => 'Semer à la volée sur sol fin et bien préparé puis recouvrir légèrement par un griffage. Semence très fine : mélanger à du sable pour répartir uniformément.'],
                    ['day_number' => 15, 'stage' => 'Levée',    'action_name' => 'Sarclage manuel (délicat, plante fragile)',   'type' => 'sarclage',    'product_suggested' => null,            'dose' => null,       'method' => 'manuel avec précaution', 'notes' => 'Désherber tôt et avec soin : les jeunes plants de fonio sont fragiles et très sensibles à la concurrence des adventices.'],
                    ['day_number' => 30, 'stage' => 'Tallage',  'action_name' => 'Observation développement',                   'type' => 'observation', 'product_suggested' => null,            'dose' => null,       'method' => 'visuel', 'notes' => 'Vérifier la densité et la vigueur des talles ; repérer tôt les zones clairsemées ou envahies.'],
                    ['day_number' => 45, 'stage' => 'Tallage',  'action_name' => 'Deuxième sarclage',                           'type' => 'sarclage',    'product_suggested' => null,            'dose' => null,       'method' => 'manuel', 'notes' => 'Dernier désherbage avant la fermeture du couvert. Sarcler superficiellement pour ne pas arracher les plants.'],
                    ['day_number' => 60, 'stage' => 'Épiaison', 'action_name' => 'Observation épiaison',                        'type' => 'observation', 'product_suggested' => null,            'dose' => null,       'method' => 'visuel', 'notes' => 'Suivre la sortie des panicules pour estimer la date de récolte ; surveiller les attaques d\'oiseaux.'],
                    ['day_number' => 80, 'stage' => 'Maturation', 'action_name' => 'Observation maturité (grain laiteux → vitreux)', 'type' => 'observation', 'product_suggested' => null,       'dose' => null,       'method' => 'visuel', 'notes' => 'Récolter dès que les grains passent du laiteux au vitreux : le fonio s\'égraine vite et se perd s\'il reste trop longtemps sur pied.'],
                    ['day_number' => 90, 'stage' => 'Récolte',  'action_name' => 'Récolte manuelle (couper tiges, battre)',     'type' => 'recolte',     'product_suggested' => null,            'dose' => null,       'method' => 'faucille + battage manuel', 'notes' => 'Faucher tôt le matin pour limiter l\'égrenage. Mettre en gerbes, sécher au soleil puis battre ; conserver les grains bien secs à l\'abri de l\'humidité.'],
                ],
            ],
            [
                ...
                'description' => $note,
                'items' => [
                    ['day_number' => 0,  'stage' => 'Pépinière',  'action_name' => 'Pépinière semis (en serre ou châssis froid)', 'type' => 'semis',       'product_suggested' => null,           'dose' => null,        'method' => 'en caissettes ou planches pépinière', 'notes' => 'Semer en pépinière sur substrat fin et désinfecté, arroser en pluie fine. Produire des plants trapus de 4-5 feuilles avant repiquage.'],
                    ['day_number' => 30, 'stage' => 'Repiquage',  'action_name' => 'Repiquage au champ + NPK 15-15-15',          'type' => 'fertilisation','product_suggested' => 'NPK 15-15-15', 'dose' => '150 kg/ha', 'method' => 'localisé au pied', 'notes' => 'Repiquer en fin de journée, écartement 70 x 50 cm, puis arroser. Placer l\'engrais légèrement décalé du pied et sur sol humide.'],
                    ['day_number' => 45, 'stage' => 'Croissance', 'action_name' => 'Apport urée + sarclage',                    'type' => 'fertilisation', 'product_suggested' => 'Urée 46%',     'dose' => '50 kg/ha',  'method' => 'épandage + sarclage manuel', 'notes' => 'Apporter au pied sur sol humide puis enfouir par sarclage pour limiter la volatilisation. Désherber tôt contre la concurrence.'],
                    ['day_number' => 55, 'stage' => 'Croissance', 'action_name' => 'Traitement préventif oïdium (soufre) + thrips (spinosad)', 'type' => 'traitement', 'product_suggested' => 'Soufre / Spinosad', 'dose' => 'selon étiquette', 'method' => 'pulvérisation foliaire', 'notes' => 'Porter gants et masque. Ne pas appliquer le soufre par forte chaleur (risque de brûlure). Pulvériser en soirée, hors floraison pour les pollinisateurs, et respecter le délai avant récolte.'],
                    ['day_number' => 60, 'stage' => 'Floraison',  'action_name' => 'Début floraison — observation',             'type' => 'observation',   'product_suggested' => null,           'dose' => null,        'method' => 'visuel', 'notes' => 'Surveiller nouaison et apparition de ravageurs (thrips, doryphore, acariens). Décider les interventions selon les seuils observés.'],
                    ['day_number' => 70, 'stage' => 'Floraison',  'action_name' => 'Traitement Botrytis si humidité excessive',  'type' => 'traitement',    'product_suggested' => 'Fongicide anti-Botrytis', 'dose' => 'selon étiquette', 'method' => 'pulvérisation si symptômes', 'notes' => 'Traiter uniquement en cas de symptômes (pourriture grise) par temps humide. Aérer le feuillage, porter des EPI, traiter en soirée et respecter le délai avant récolte.'],
                    ['day_number' => 80, 'stage' => 'Récolte',    'action_name' => 'Début récolte fruits',                      'type' => 'recolte',       'product_suggested' => null,           'dose' => null,        'method' => 'manuel, tous les 2-3 jours', 'notes' => 'Récolter les fruits brillants encore jeunes, avant durcissement des graines. Couper le pédoncule au sécateur tous les 2-3 jours.'],
                    ['day_number' => 90, 'stage' => 'Récolte',    'action_name' => 'Récolte principale',                        'type' => 'recolte',       'product_suggested' => null,           'dose' => null,        'method' => 'manuel', 'notes' => 'Manipuler avec soin pour éviter les chocs et conserver les fruits à l\'ombre. Une récolte régulière prolonge la production.'],
                ],
            ],
        ];
