...
**Reste avant prod** : rotation des secrets (manuel) ; **P2-⑫** staging Linux + 5 parcours E2E ; P1 concurrence réelle sur staging (k6/parallèle) ; re-drill backup SUR la machine de prod ; `whatsapp.admin_phone` configuré.
