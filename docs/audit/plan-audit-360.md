...
**Reste avant prod** : rotation des secrets ; P1 concurrence réelle sur staging MySQL (k6/parallèle) ; **P2 reliquat** (⑩ runbooks déploiement tri-mode, ⑪ monitoring erreurs→WhatsApp, ⑫ staging Linux + 5 parcours E2E).
