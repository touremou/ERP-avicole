...
**Reste P0** : A2 (trancher le doublon sync — router `push/pull` API v1, déprécier `SyncController` web, cf. `docs/mobile/phase-0-spec.md` §5) ; rotation des secrets avant prod.
