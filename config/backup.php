...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // Le code source vit dans Git : on ne sauvegarde QUE les
     ...
     */
    'notifications' => [
        // Notifications par e-mail DÉSACTIVÉES par défaut pour ne pas dépendre
        // d'une configuration mail en production. Les échecs restent journalisés
        // (storage/logs) et l'âge du dernier backup est visible dans l'IHM admin.
        // Réactivez en remettant ['mail'] (et en renseignant 'to' ci-dessous).
        'notifications' => [
